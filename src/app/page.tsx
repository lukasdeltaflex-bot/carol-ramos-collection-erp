          ...
          <form onSubmit={authMode === "login" ? handleLogin : handleSignUp} className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <PasswordInput
                ...
                className="py-2.5 rounded-xl border border-border bg-card/50 placeholder-muted-foreground text-xs focus:bg-card focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all"
              />
            </div>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-primary text-primary-foreground text-xs font-bold rounded-xl hover:bg-primary/95 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary hover:scale-[1.01] active:scale-[0.99] transition-all disabled:opacity-50 shadow-md cursor-pointer mt-2"
            >
              <span>
                {authLoading
                  ? "Processando..."
