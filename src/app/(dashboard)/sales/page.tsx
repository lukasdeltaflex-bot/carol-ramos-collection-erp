          ...
          <div className="flex flex-col justify-between h-full min-h-0 bg-card/40 border border-border rounded-2xl p-4">
            ...
            <div className="border-t border-border pt-4 mt-2 space-y-3.5 shrink-0 text-xs">
              ...
              {paymentMethod === "credit_card" && (
                <div className="p-3 rounded-xl border border-border bg-muted/20 space-y-1 animate-in fade-in duration-200">
                  <label className="text-[8px] font-bold text-muted-foreground uppercase">Parcelamento</label>
                  <select
                    value={installments}
